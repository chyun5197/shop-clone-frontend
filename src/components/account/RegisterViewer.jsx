                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input
                                    ...
                                    type="text"
                                /> <a> </a>
                                <span className="line-through-ment"> (이메일 주소)</span> => 자유롭게
                            </td>
                        </tr>
                        ...
                        <tr className="">
                            ...
                            <td>
                                ...
                                <a> </a>
                                <input id="mobile2" name="mobile[]" maxLength="4" size="10"
                                       placeholder="" type="text"/> - <a> </a>
                                <input id="mobile3" name="mobile[]" maxLength="4" size="10"
